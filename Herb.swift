...
// Insert code here to add functionality to your managed object subclass
    ...
    convenience init(pinyinName: String? = nil, botanicalName: String? = nil, englishName: String, category: String? = nil, temp: String? = nil, meridians: String? = nil, uses: String? = nil, majorFormulas: String? = nil, imageId1: String? = "", imageId2: String? = "", context: NSManagedObjectContext = Stack.sharedStack.managedObjectContext) {
